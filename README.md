Ai-health-care-AssistantAI Healthcare Assistant Project Description
Set Up Environment:
...
.\myenv\Scripts\activate Install Required Packages:

Install all necessary packages from requirements.txt:

pip install -r .\requirements.txt Packages Used:

The project utilizes the following packages:

python import streamlit as st import nltk from transformers import pipeline from nltk.corpus import stopwords from nltk.tokenize import word_tokenize Code Creation:
